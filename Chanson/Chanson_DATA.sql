...
--Musique Classique
INSERT INTO Chanson(id, titre, duree, album, createurice, genremusical) VALUES(DEFAULT, 'Symphonie n° 40', 1500, (SELECT id FROM Album WHERE titre = 'Compliation Various Artists'), (SELECT id FROM Profil_Artiste WHERE nom = 'Mozart'), 'Classique');
INSERT INTO Chanson(id, titre, duree, album, createurice, genremusical) VALUES(DEFAULT, 'Eine kleine Nachtmusik', 1200, (SELECT id FROM Album WHERE titre = 'Compliation Various Artists'), (SELECT id FROM Profil_Artiste WHERE nom = 'Mozart'), 'Classique');
INSERT INTO Chanson(id, titre, duree, album, createurice, genremusical) VALUES(DEFAULT, 'Le Nozze di Figaro', 10800, (SELECT id FROM Album WHERE titre = 'Compliation Various Artists'), (SELECT id FROM Profil_Artiste WHERE nom = 'Mozart'), 'Classique');

INSERT INTO Chanson(id, titre, duree, album, createurice, genremusical) VALUES(DEFAULT, 'Nocturne en mi bémol majeur', 300, (SELECT id FROM Album WHERE titre = 'Compliation Various Artists'), (SELECT id FROM Profil_Artiste WHERE nom = 'Chopin'), 'Classique');
INSERT INTO Chanson(id, titre, duree, album, createurice, genremusical) VALUES(DEFAULT, 'Ballade en sol mineur', 600, (SELECT id FROM Album WHERE titre = 'Compliation Various Artists'), (SELECT id FROM Profil_Artiste WHERE nom = 'Chopin'), 'Classique');
INSERT INTO Chanson(id, titre, duree, album, createurice, genremusical) VALUES(DEFAULT, 'Polonaise héroïque', 420, (SELECT id FROM Album WHERE titre = 'Compliation Various Artists'), (SELECT id FROM Profil_Artiste WHERE nom = 'Chopin'), 'Classique');

--Autre
INSERT INTO Chanson(id, titre, duree, album, createurice, genremusical) VALUES(DEFAULT, 'Thriller', 358, (SELECT id FROM Album WHERE titre = 'Compliation Various Artists'), (SELECT id FROM Profil_Artiste WHERE nom = 'Michael Jackson'), 'Pop');
INSERT INTO Chanson(id, titre, duree, album, createurice, genremusical) VALUES(DEFAULT, 'Billie Jean', 296, (SELECT id FROM Album WHERE titre = 'Compliation Various Artists'), (SELECT id FROM Profil_Artiste WHERE nom = 'Michael Jackson'), 'Pop');
INSERT INTO Chanson(id, titre, duree, album, createurice, genremusical) VALUES(DEFAULT, 'Beat It', 258, (SELECT id FROM Album WHERE titre = 'Compliation Various Artists'), (SELECT id FROM Profil_Artiste WHERE nom = 'Michael Jackson'), 'Pop');

INSERT INTO Chanson(id, titre, duree, album, createurice, genremusical) VALUES(DEFAULT, 'Can''t Help Falling in Love', 177, (SELECT id FROM Album WHERE titre = 'Compliation Various Artists'), (SELECT id FROM Profil_Artiste WHERE nom = 'Elvis Presley'), 'Rock');
INSERT INTO Chanson(id, titre, duree, album, createurice, genremusical) VALUES(DEFAULT, 'Suspicious Minds', 250, (SELECT id FROM Album WHERE titre = 'Compliation Various Artists'), (SELECT id FROM Profil_Artiste WHERE nom = 'Elvis Presley'), 'Rock');
INSERT INTO Chanson(id, titre, duree, album, createurice, genremusical) VALUES(DEFAULT, 'Jailhouse Rock', 146, (SELECT id FROM Album WHERE titre = 'Compliation Various Artists'), (SELECT id FROM Profil_Artiste WHERE nom = 'Elvis Presley'), 'Rock');

INSERT INTO Chanson(id, titre, duree, album, createurice, genremusical) VALUES(DEFAULT, 'Like a Rolling Stone', 368, (SELECT id FROM Album WHERE titre = 'Compliation Various Artists'), (SELECT id FROM Profil_Artiste WHERE nom = 'Bob Dylan'), 'Rock');
INSERT INTO Chanson(id, titre, duree, album, createurice, genremusical) VALUES(DEFAULT, 'Blowin'' in the Wind', 155, (SELECT id FROM Album WHERE titre = 'Compliation Various Artists'), (SELECT id FROM Profil_Artiste WHERE nom = 'Bob Dylan'), 'Folk');
INSERT INTO Chanson(id, titre, duree, album, createurice, genremusical) VALUES(DEFAULT, 'The Times They Are a-Changin', 184, (SELECT id FROM Album WHERE titre = 'Compliation Various Artists'), (SELECT id FROM Profil_Artiste WHERE nom = 'Bob Dylan'), 'Folk');

INSERT INTO Chanson(id, titre, duree, album, createurice, genremusical) VALUES(DEFAULT, 'Like a Virgin', 224, (SELECT id FROM Album WHERE titre = 'Compliation Various Artists'), (SELECT id FROM Profil_Artiste WHERE nom = 'Madonna'), 'Pop');
INSERT INTO Chanson(id, titre, duree, album, createurice, genremusical) VALUES(DEFAULT, 'Vogue', 314, (SELECT id FROM Album WHERE titre = 'Compliation Various Artists'), (SELECT id FROM Profil_Artiste WHERE nom = 'Madonna'), 'Pop');
INSERT INTO Chanson(id, titre, duree, album, createurice, genremusical) VALUES(DEFAULT, 'Material Girl', 222, (SELECT id FROM Album WHERE titre = 'Compliation Various Artists'), (SELECT id FROM Profil_Artiste WHERE nom = 'Madonna'), 'Pop');

INSERT INTO Chanson(id, titre, duree, album, createurice, genremusical) VALUES(DEFAULT, 'Imagine', 183, (SELECT id FROM Album WHERE titre = 'Compliation Various Artists'), (SELECT id FROM Profil_Artiste WHERE nom = 'John Lennon'), 'Rock');
INSERT INTO Chanson(id, titre, duree, album, createurice, genremusical) VALUES(DEFAULT, 'Jealous Guy', 243, (SELECT id FROM Album WHERE titre = 'Compliation Various Artists'), (SELECT id FROM Profil_Artiste WHERE nom = 'John Lennon'), 'Rock');
INSERT INTO Chanson(id, titre, duree, album, createurice, genremusical) VALUES(DEFAULT, 'Instant Karma!', 213, (SELECT id FROM Album WHERE titre = 'Compliation Various Artists'), (SELECT id FROM Profil_Artiste WHERE nom = 'John Lennon'), 'Rock');

INSERT INTO Chanson(id, titre, duree, album, createurice, genremusical) VALUES(DEFAULT, 'Space Oddity', 295, (SELECT id FROM Album WHERE titre = 'Compliation Various Artists'), (SELECT id FROM Profil_Artiste WHERE nom = 'David Bowie'), 'Rock');
INSERT INTO Chanson(id, titre, duree, album, createurice, genremusical) VALUES(DEFAULT, 'Heroes', 363, (SELECT id FROM Album WHERE titre = 'Compliation Various Artists'), (SELECT id FROM Profil_Artiste WHERE nom = 'David Bowie'), 'Rock');
INSERT INTO Chanson(id, titre, duree, album, createurice, genremusical) VALUES(DEFAULT, 'Let''s Dance', 287, (SELECT id FROM Album WHERE titre = 'Compliation Various Artists'), (SELECT id FROM Profil_Artiste WHERE nom = 'David Bowie'), 'Rock');

INSERT INTO Chanson(id, titre, duree, album, createurice, genremusical) VALUES(DEFAULT, 'Hey Jude', 431, (SELECT id FROM Album WHERE titre = 'Compliation Various Artists'), (SELECT id FROM Profil_Artiste WHERE nom = 'Paul McCartney'), 'Rock');
INSERT INTO Chanson(id, titre, duree, album, createurice, genremusical) VALUES(DEFAULT, 'Yesterday', 157, (SELECT id FROM Album WHERE titre = 'Compliation Various Artists'), (SELECT id FROM Profil_Artiste WHERE nom = 'Paul McCartney'), 'Rock');
...
INSERT INTO Chanson(id, titre, duree, album, createurice, genremusical) VALUES(DEFAULT, 'Superstition', 278, (SELECT id FROM Album WHERE titre = 'Compliation Various Artists'), (SELECT id FROM Profil_Artiste WHERE nom = 'Stevie Wonder'), 'Soul');
INSERT INTO Chanson(id, titre, duree, album, createurice, genremusical) VALUES(DEFAULT, 'Isn''t She Lovely', 215, (SELECT id FROM Album WHERE titre = 'Compliation Various Artists'), (SELECT id FROM Profil_Artiste WHERE nom = 'Stevie Wonder'), 'Soul');
INSERT INTO Chanson(id, titre, duree, album, createurice, genremusical) VALUES(DEFAULT, 'Signed, Sealed, Delivered', 179, (SELECT id FROM Album WHERE titre = 'Compliation Various Artists'), (SELECT id FROM Profil_Artiste WHERE nom = 'Stevie Wonder'), 'Soul');

INSERT INTO Chanson(id, titre, duree, album, createurice, genremusical) VALUES(DEFAULT, 'Bohemian Rhapsody', 367, (SELECT id FROM Album WHERE titre = 'Compliation Various Artists'), (SELECT id FROM Profil_Artiste WHERE nom = 'Freddie Mercury'), 'Rock');
INSERT INTO Chanson(id, titre, duree, album, createurice, genremusical) VALUES(DEFAULT, 'Somebody to Love', 296, (SELECT id FROM Album WHERE titre = 'Compliation Various Artists'), (SELECT id FROM Profil_Artiste WHERE nom = 'Freddie Mercury'), 'Rock');
INSERT INTO Chanson(id, titre, duree, album, createurice, genremusical) VALUES(DEFAULT, 'We Will Rock You', 122, (SELECT id FROM Album WHERE titre = 'Compliation Various Artists'), (SELECT id FROM Profil_Artiste WHERE nom = 'Freddie Mercury'), 'Rock');
